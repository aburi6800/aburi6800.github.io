...
- 双方のアセンブリリストを比較すると、参照渡しにデコレータ`__z88dk_fastcall`を付けても、値渡しの方が速いという結果となった。値渡しは、`__z88dk_fastcall`を付けると逆に遅くなっている。
  （zcc v23854でのコンパイル結果）
  ...
  - 値渡し
    ...
    関数（デコレータ`__z88dk_factcall`を付与）：107Tサイクル

    ```asm
    15                          ._testFunc_byVal
    15  0000  e5                  push  hl                    ; 11
    15  0001  210000              ld  hl,0  ;const            ; 7
    15  0004  39                  add hl,sp                   ; 11
    15  0005  e5                  push  hl                    ; 11
    15  0006  6e                  ld  l,(hl)                  ; 7
    15  0007  2600                ld  h,0                     ; 7
    15  0009  23                  inc hl                      ; 6
    15  000a  23                  inc hl                      ; 6
    15  000b  d1                  pop de                      ; 10
    15  000c  7d                  ld  a,l                     ; 4
    15  000d  12                  ld  (de),a                  ; 7
    15  000e  c1                  pop bc                      ; 10
    15  000f  c9                  ret                         ; 10
    ```
  ...
  - 参照渡し
    ...
    関数（デコレータ`__z88dk_factcall`を付与）：87Tサイクル
